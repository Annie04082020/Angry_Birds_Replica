...
### 心得
- **111310452 黃安華**
  - 透過這次復刻 Angry Birds 的實作過程，我也是初次帶領團隊共同製作一個軟體專題，也在進度管理、時間管理和任務分配上有些瑕疵，經過一個學期和助教、隊友的磨合過程中，也學習到了寶貴的經驗。也因為我選擇了挑戰需要復刻物理系統的遊戲，在這方面請教了 AI 許多，了解到了不同碰撞箱的算法，也了解到 C++ 的特性與限制。
  - 我認為在這次OOPL實習課程擔任管理者的經驗對我來說收穫很多，除了管理之外，在負責解構 Angry Birds 的過程中與隊友、AI助理的腦力激盪也是很有趣的一件事情。
  - 最後在專題實作方面，我們的物理系統並沒有完美重現非常合理的物理現象，在物體之間的碰撞還是會累積衝量的情形，也有很多細節沒有重現的與原作相同，像是縮放的部分就因為同時讀取的圖片量太多而取折衷方式實作。另外也有一些像是拖曳後鳥跟彈弓分離的情形比較來不及修正，也是我們在進度安排時沒有預料到的情況。
